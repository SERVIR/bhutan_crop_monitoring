...
def dashboard(request):
    ...
    context = {'dzongkhags': dzongkhag_data, 'data_layers': [
        ...
        {"hasVisualization": True, "ui_id": 'crop_land_', "title": "Crop land extent ", "url": "https://csthredds.servirglobal.net/thredds/wms/Agg/ucsb-chirps_global_0.05deg_daily.nc4?service=WMS&version=1.3.0&", "attribution": "BillyZ 3",
         ...
         "belowrange": "transparent", "default_year": "2016", "default_month": "01", "default_on": False},{"hasVisualization": True, "ui_id": 'average_soil_moisture_', "title": "Average Soil Moisture", "url": "https://thredds.servirglobal.net/thredds/wms/agg/crop/global/usda-smap_global_10km_3d_monthly_avg.nc4?service=WMS&version=1.3.0&", "attribution": "BillyZ 3",
         "layers": "soil_moisture_monthly_avg", "default_style": "boxfill/cape_surface", "default_color_range": "0,28", "overrange": "transparent",
